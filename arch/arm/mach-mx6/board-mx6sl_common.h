...
/* BCM43xx Wifi Bleutooth */
#define MX6SL_BRD_BT_DEVICE_WAKE	IMX_GPIO_NR(2, 4)
#define MX6SL_BRD_BT_REG_ON		IMX_GPIO_NR(2, 5)
#define MX6SL_BRD_WIFI_REG_ON		IMX_GPIO_NR(2, 6)
#define MX6SL_BRD_WIFI_DEVICE_WAKE	IMX_GPIO_NR(2, 7)
#define MX6SL_BRD_WIFI_HOST_WAKE	IMX_GPIO_NR(2, 8)
#define MX6SL_BRD_BT_HOST_WAKE		IMX_GPIO_NR(2, 9)
...
static iomux_v3_cfg_t mx6sl_brd_bcm43xx_pads[] = {
	MX6SL_PAD_EPDC_VCOM1__GPIO_2_4,          /* BT D WAKE   */
	MX6SL_PAD_EPDC_BDR0__GPIO_2_5,           /* BT REG ON   */
	MX6SL_PAD_EPDC_BDR1__GPIO_2_6,           /* WIFI REG ON */

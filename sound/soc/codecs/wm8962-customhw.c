...
SOC_SINGLE("Main DMIC", WM8962_PWR_MGMT_1, 10, 1, 0),
SOC_SINGLE("DMIC ADCL", WM8962_PWR_MGMT_1, 3, 1, 0),
SOC_SINGLE("DMIC ADCR", WM8962_PWR_MGMT_1, 2, 1, 0),
};
...
static int wm8962_probe(struct snd_soc_codec *codec)
{
	...
	/* SYSCLK Max Clock 12.288 MHz MCLK / 2 */
	snd_soc_update_bits(codec, WM8962_CLOCKING1, WM8962_MCLKDIV_MASK, 1);
	/* GPIO Clock Output */
	snd_soc_update_bits(codec, WM8962_PWR_MGMT_1, WM8962_OPCLK_ENA, 0x1);
	/* GPIO Clock SYSCLK / 4 */
	snd_soc_update_bits(codec, WM8962_CLOCKING_3, WM8962_OPCLK_DIV_MASK, 0x3);

	snd_soc_update_bits(codec, WM8962_CLOCKING2, WM8962_SYSCLK_ENA, 1);
